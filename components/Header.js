...
function Header({placeholder}) {
    ...
    return (
        <header className='sticky top-0 z-50 bg-white grid grid-cols-3  shadow-md py-5 px-5
        md:px-10'>
            {/* i removed the bg-white from the upper line */}
            {/* left */}
           ...
           <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
               ...
               rounded-full p-2 cursor-pointer md:xm-2" />
           ...
           {searchInput && (
               <div className="flex flex-col col-span-3 mx-auto">
                ...
                <div className="flex items-center border-b mb-4">
                    <h2 className="text-2xl flex-grow border-semibold">Number of Guests</h2>
